...
heart_data =pd.read_csv('D:\\PROJECTS\\HEART DISEASE PREDICTION PROJECT\\Heart.csv')



#loading the saved models

Heart_Disease =pickle.load(open('D:\PROJECTS\HEART DISEASE PREDICTION PROJECT\Heart_model.sav','rb'))
